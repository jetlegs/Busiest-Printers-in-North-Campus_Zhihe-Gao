...
import numpy as np
import logging
from printer_proj.data_proc import main, data_processing
...
PROJ_DIR = os.path.join(MAIN_DIR, 'printer_proj')
DATA_DIR = os.path.join(PROJ_DIR, 'data')
SAMPLE_DATA_FILE_LOC = os.path.join(DATA_DIR, 'printer_data.csv')

# Assumes running tests from the main directory
DEF_CSV_OUT = os.path.join(MAIN_DIR, 'printer_data_stats.csv')
DEF_PNG_OUT = os.path.join(MAIN_DIR, 'printer_data_stats.png')
    ...
    def testSampleData(self):
        ...
        try:
            ...
            with capture_stdout(main, test_input) as output:
                self.assertTrue("printer_data_stats.csv" in output)

            self.assertTrue(os.path.isfile("printer_data_stats.csv"))
            self.assertTrue(os.path.isfile("printer_data_stats.png"))
        finally:
